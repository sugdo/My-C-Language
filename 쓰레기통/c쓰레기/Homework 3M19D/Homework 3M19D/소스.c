...
description : check queue for input
input : none
output : return -1 if queue is empty, else return 0
*/
int queue_empty()
{
	if (front == 0)
...
/*
queue_full function
description : check Queue for remove
input : none
output : return -1 if queue is full, else return 0
*/
int queue_full()
{
